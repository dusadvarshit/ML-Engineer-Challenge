...
async def unhandled_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    return JSONResponse(status_code=500, content=_error_payload("internal_error", "An internal server error occurred."))
...
def _status_code_name(status_code: int) -> str:
    ...
    return {
        ...
        422: "validation_error", 429: "rate_limited", 500: "inference_failed",
